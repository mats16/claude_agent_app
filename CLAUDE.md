...
**Key Files:**
- `models/Session.ts` - SessionId wrapper + Session domain model
- `db/sessions.ts` - Database operations with RLS

**Security:**
- `SessionId.fromString()` validates TypeID prefix ('session')
